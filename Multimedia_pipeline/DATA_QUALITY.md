...
- **loc-50 event latitudes (687/688/689):** field-recording errors (single wrong decimal digit; longitudes fine) → initially set to provisional cluster values. **Finalized 2026-07-23** against the manilla (Sven): 687 & 688 confirmed correct (unchanged), 689 corrected. All four loc-50 events (686–689) now cluster within ~290 m; `eventRemarks` promoted provisional→verified. **[#18](https://github.com/svenbuerki/Genetic-Rescue-DB/issues/18) resolved.**
