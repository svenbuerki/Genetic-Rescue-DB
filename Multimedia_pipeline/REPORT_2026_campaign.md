...
*Last refreshed: 2026-07-21 (through the July 16/17/20 load — EO26 complete, EO27 loc 37/50, EO61 loc 38 + EO29 loc 8. The 2026 collection season is essentially complete.)*
...
- `LEPA_SQL.db` — **Locations 49, Events 714, Occurrences 3,767, Multimedia 3,352, Phenotyping 2,282** (incl. all prior-year data + the 2026 season + the genotyping integration).
